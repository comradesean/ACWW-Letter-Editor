...
bool NDSRom::parseHeader() {
    ...
    std::cout << "Game Title: " << std::string(m_header.gameTitle, 12) << std::endl;
    std::cout << "Game Code: " << std::string(m_header.gameCode, 4) << std::endl;
    std::cout << "FNT Offset: 0x" << std::hex << m_header.fntOffset << std::endl;
    std::cout << "FNT Size: 0x" << m_header.fntSize << std::endl;
    std::cout << "FAT Offset: 0x" << m_header.fatOffset << std::endl;
    std::cout << "FAT Size: 0x" << m_header.fatSize << std::dec << std::endl;
...
bool NDSRom::parseFAT() {
    ...
    std::cout << "FAT entries: " << numEntries << std::endl;
    return true;
}
...
bool NDSRom::parseFNT() {
    ...
    // rootParentId for root directory contains total number of directories
    uint16_t numDirectories = rootParentId;
    std::cout << "Number of directories: " << numDirectories << std::endl;
